...
const DateTimeDropButton = ({ propdate, proptime }) => {
    const [date, setDate] = React.useState(propdate);
    const [time, setTime] = React.useState(proptime ? proptime : '');
...
const DateTimeInput = ({ date, time }) =>
    <DateTimeDropButton date={date} time={time} />
